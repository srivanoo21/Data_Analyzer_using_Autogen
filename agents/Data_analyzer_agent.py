...
#
# This file defines the DataAnalyzerAgent used in the agent team.
# The agent is responsible for analyzing CSV data and answering user questions
# by generating Python code. It collaborates with the CodeExecutorAgent to run code
# and handles tasks such as planning, code generation, library installation, and output analysis.
# -------------------------------------------------------------

from autogen_agentchat.agents import AssistantAgent

# System message that guides the DataAnalyzerAgent's behavior and instructions
...
# Factory function to create and return a DataAnalyzerAgent instance
# model_client: The OpenAI model client used for generating responses and code
